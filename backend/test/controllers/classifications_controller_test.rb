...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { nombre: @classification.nombre } }, as: :json
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { nombre: @classification.nombre } }, as: :json
    assert_response 200
  end
